...
module.exports.deleteComment = (req, res, next) => {
    ...
    return module.exports.getOneComment(commentid, req)
        .then(instance => {
            if (instance === null) {
                return Promise.reject({
                    message: 'Comment does not exist  GETONECOMMENT.',
                    status: 404,
                });
            }
...
module.exports.getComment = (req, res, next) => {
    ...
    return module.exports.getOneComment(commentid, req)
        .then(comment => {
            if (comment === null) {
                return Promise.reject({
                    message: 'Comment does not exist GETCOMMENT.',
                    status: 404,
                });
            }
            ...
            if (lastCommentId) {
                return Models.Comment.findById(lastCommentId)
                    .then(instance => {
                        if (instance === null) {
                            return Promise.reject({
                                message: 'Comment does not exist thisssssss.',
                                status: 404,
                            });
                        }
...
module.exports.getOneComment = (id, req) => {
    ...
    return Models.Comment.findById(id)
        .then(instance => {
            if (instance === null) {
                return Promise.reject({
                    message: 'Comment does not exist GITONECOMMENT.',
                    status: 404,
                });
            }
